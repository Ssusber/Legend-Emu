...
public class ClientHandler implements IoHandler {
	...
	public void exceptionCaught(IoSession arg0, Throwable arg1)
			throws Exception {
		LoginServer.addToLog("session " + arg0.getId() + " exception : " + arg1.getMessage());
	}
	...
	public void messageReceived(IoSession arg0, Object arg1) throws Exception {
		...
		int i = 0;
		do {
			LoginServer.addToLog("Login: Recv << " + s[i] + " to session " + arg0.getId());
	...
	public void messageSent(IoSession arg0, Object arg1) throws Exception {
		LoginServer.addToLog("Login: Send >> " + arg1.toString() + " to session " + arg0.getId());
	}
	
	@Override
	public void sessionClosed(IoSession arg0) throws Exception {
		LoginServer.addToLog("session " + arg0.getId() + " closed");
	...
	public void sessionCreated(IoSession arg0) throws Exception {
		LoginServer.addToLog("session " + arg0.getId() + " created");
	...
	public void sessionIdle(IoSession arg0, IdleStatus arg1) throws Exception {
		LoginServer.addToLog("session " + arg0.getId() + " idle");
	}
	
	@Override
	public void sessionOpened(IoSession arg0) throws Exception {
		LoginServer.addToLog("session " + arg0.getId() + " oppened");
