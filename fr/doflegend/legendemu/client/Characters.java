...
public class Characters{
	...
	*/
		...
		for (Entry<Integer,Map<String,String>> entry : _quests.entrySet()) // Chaque quÃªte 
		{
			if(!entry.getValue().get("curStep").equals("-1")) // Si non terminÃ©e
			{
				...
				for(String toDo : splitObjectives)
				{
					...
					if(type == 1 || type == 2 || type == 4 || type == 8) // Objectifs simple : "Aller voir PNJ" OU "Montrer Nbre Item Ã  Pnj" OU "DÃ©couvrir carte MAPID" OU "Utiliser objet X" 
					{
	...
	public void addNewQuest(int questId)
	{
		...
		{
			//SocketManager.GAME_SEND_MESSAGE(this, "Vous avez dÃ©jÃ  cette quÃªte !", "FF0000");
			return;
		}
		...
		{
			//SocketManager.GAME_SEND_MESSAGE(this, "Cette quÃªte nÃ©cessite de faire une autre quÃªte.", "FF0000");
			return;
		}
