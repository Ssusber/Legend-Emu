...
import fr.doflegend.legendemu.object.AuctionHouse;
import fr.doflegend.legendemu.object.Guild;
import fr.doflegend.legendemu.object.Maps;
import fr.doflegend.legendemu.object.Mount;
import fr.doflegend.legendemu.object.Objects;
import fr.doflegend.legendemu.object.Trunk;
...
import fr.doflegend.legendemu.object.Maps.InteractiveObject;
...
public class SocketManager {
	...
	public static void MULTI_SEND_Af_PACKET(GameSendThread out,int position, int totalAbo, int totalNonAbo, String subscribe,
			int queueID)
	{
		...
		if(Config.debug)
			LoginServer.addToSockLog("Serv: Send>>"+packet.toString());
	}
	...
	public static void GAME_SEND_PERSO_LIST(GameSendThread out,
			Map<Integer, Characters> persos, int subscriber)
	{
		StringBuilder packet = new StringBuilder();
    ...
    public static void GAME_SEND_am_ALIGN_PACKET_TO_SUBAREA(Characters perso, String str) {
		String packet = "am" + str;
		send(perso, packet);

	}
	public static void GAME_SEND_aM_ALIGN_PACKET_TO_AREA(Characters perso, String str) {
		String packet = "aM" + str;
		send(perso, packet);

	}
	public static void SEND_Cb_CONQUETE(Characters perso, String str) {
	...
	public static void SEND_CIV_INFOS_CONQUETE(Characters perso) {
		String packet = "CIV";
		send(perso, packet);

	}
	public static void SEND_CW_INFO_CONQUETE(Characters perso, String str) {
		String packet = "CW" + str;
		send(perso, packet);

	}
	public static void SEND_CB_BONUS_CONQUETE(Characters perso, String str) {
		String packet = "CB" + str;
		send(perso, packet);

	}
	public static void SEND_Wp_MENU_Prisme(Characters perso) {
		String packet = "Wp" + perso.parsePrismesList();
		send(perso.get_compte().getGameThread().get_out(), packet);
	}
	public static void SEND_Ww_CLOSE_Prisme(Characters out) {
		String packet = "Ww";
		send(out, packet);
	}
	public static void SEND_CP_INFO_DEFENSEURS_PRISME(Characters perso, String str) {
		String packet = "CP" + str;
		send(perso, packet);
	}
	
	public static void SEND_Cp_INFO_ATTAQUANT_PRISME(Characters perso, String str) {
		String packet = "Cp" + str;
		send(perso, packet);
	}
	public static void SEND_CA_ATTAQUE_MESSAGE_PRISME(Characters perso, String str) {
	...
	public static void GAME_SEND_OCO_PACKET_REMOVE(Characters out, Objects obj) {
	...
	public static void REALM_SEND_MESSAGE_DECO(Characters P, int MSG_ID, String args) {
		String packet = "M0" + MSG_ID + "|" + args;
		send(P, packet);
	}
/**TODO: Fin packets prismes **/
	
	public static void GAME_SEND_VOTE_BLOC(Characters perso, String str) {
	...
	public static void GAME_SEND_Rx_PACKET(Characters out)
	{
	...
	public static void GAME_SEND_Rn_PACKET(Characters out,String name)
	{
	...
	public static void GAME_SEND_Re_PACKET(Characters out,String sign,Mount DD)
	{
	...
	public static void GAME_SEND_ADD_PLAYER_TO_MAP(Maps map, Characters perso)
	{
		...
		for(Characters z : map.getPersos()) send(z,packet);	
		if(Config.debug)
			GameServer.addToSockLog("Game: Map "+map.get_id()+": Send>>"+packet);
	}
	...
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_MAP(Maps map,int arg1, int guid1,int guid2,int cell1,String str1,int cell2,String str2)
	{
		...
		for(Characters z : map.getPersos()) send(z,packet.toString());
		if(Config.debug)
			GameServer.addToSockLog("Game: Map: Send>>"+packet.toString());
	}
	
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_PLAYER(Characters p, Maps map,int arg1, int guid1,int guid2,int cell1,String str1,int cell2,String str2)
	{
		StringBuilder packet = new StringBuilder();
		packet.append("Gc+").append(guid1).append(";").append(arg1).append("|").append(guid1).append(";").append(cell1).append(";").append(str1).append("|").append(guid2).append(";").append(cell2).append(";").append(str2);
		send(p,packet.toString());
	...
	public static void GAME_SEND_MAP_GMS_PACKETS(Characters _perso, String packet)
	{
		send(_perso, packet);
		if(Config.debug)
			GameServer.addToSockLog("Game: Send >> "+packet);
	...
	public static void GAME_SEND_GJK_PACKET(Characters out,int state,int cancelBtn,int duel,int spec,long time,int unknown)
	{
		StringBuilder packet = new StringBuilder();
	...
	public static void GAME_SEND_ILS_PACKET(Characters out,int i)
	{
		String packet = "ILS"+i;
		send(out,packet);
		if(Config.debug)
			GameServer.addToSockLog("Game: Send >> "+packet);
	}public static void GAME_SEND_ILF_PACKET(Characters P,int i)
	{
		String packet = "ILF"+i;
		send(P,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_MESSAGE(Characters out,String mess, String color)
	{
	...
	public static void GAME_SEND_GS_PACKET(Characters out)
	{
		String packet = "GS";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_GTL_PACKET(Characters out,Fight fight)
	{
	...
	public static void GAME_SEND_GAMETURNSTART_PACKET(Characters P,int guid, int time)
	{
		String packet = "GTS"+guid+"|"+time;
		send(P,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_BN(Characters out)
	{
		String packet = "BN";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_cMK_PACKET_TO_ALIGN(String suffix,int guid,String name,String msg, Characters _perso)
	{
		String packet = "cMK"+suffix+"|"+guid+"|"+name+"|"+msg;
		for(Characters perso : World.getOnlinePersos())
		{
	...
	{
		String packet = "cMK"+suffix+"|"+guid+"|"+name+"|"+msg;
		for(Characters perso : World.getOnlinePersos())if(perso.isOnline())if(perso.get_compte() != null)if(perso.get_compte().get_gmLvl()>0)send(perso,packet);
		if(Config.debug)
			GameServer.addToSockLog("Game: ALL("+World.getOnlinePersos().size()+"): Send>>"+packet);
	}
	...
	public static void GAME_SEND_ECK_PACKET(Characters out, int type,String str)
	{
	...
	public static void GAME_SEND_ITEM_VENDOR_LIST_PACKET(Characters p, NPC npc)
	{
	...
	public static void GAME_SEND_EV_PACKET(Characters out) {
		String packet = "EV";
		send(out, packet);
	}
	...
	public static void GAME_SEND_OBJECT_QUANTITY_PACKET(Characters out, Objects obj)
	{
	...
	public static void GAME_SEND_OAKO_PACKET(Characters out, Objects obj)
	{
	...
	public static void GAME_SEND_ESK_PACKEt(Characters out)
	{
		String packet = "ESK";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_REMOVE_ITEM_PACKET(Characters out, int guid)
	{
	...
	public static void GAME_SEND_OBJET_MOVE_PACKET(Characters out,Objects obj)
	{
	...
	public static void GAME_SEND_EXCHANGE_MOVE_OK(Characters out,char type,String signe,String s1)
	{
	...
	public static void GAME_SEND_EXCHANGE_MOVE_OK_FM(Characters out,char type,String signe,String s1)
	{
		String packet = "EmK"+type+signe;
		if(!s1.equals(""))
			packet += s1;
	...
	public static void GAME_SEND_PR_PACKET(Characters out)
	{
		String packet = "PR";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_PM_ADD_PACKET_TO_GROUP(Group g, Characters p)
	{
		...
		for(Characters P : g.getPersos())send(P,packet);
		if(Config.debug)
			GameServer.addToSockLog("Game: Groupe: Send>>"+packet);
	}
	...
	public static void GAME_SEND_FRIEND_ONLINE(Characters logando, Characters amigo) 
	{
	...
	public static void GAME_SEND_GDO_PACKET(Characters p, char c,int cell, int itm, int i)
	{
		String packet = "GDO"+c+cell+";"+itm+";"+i;
		send(p,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_WC_PACKET(Characters perso)
	{
	...
	public static void GAME_SEND_WV_PACKET(Characters out)
	{
		String packet = "WV";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_ZAAPI_PACKET(Characters perso, String list) {
		String packet = "Wc" + perso.get_curCarte().get_id()+ "|"+list;
		send(perso, packet);
		GameServer.addToSockLog("Game: Send >> " + packet);
	}
	
	public static void GAME_SEND_CLOSE_ZAAPI_PACKET(Characters out) {
		String packet = "Wv";
		send(out, packet);
		GameServer.addToSockLog("Game: Send >> " + packet);
	}
	
	public static void GAME_SEND_WUE_PACKET(Characters out)
	{
		String packet = "WUE";
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_EMOTE_LIST(Characters perso,String s, String s1)
	{
	...
	public static void GAME_SEND_NO_EMOTE(Characters out)
	{
		String packet = "eUE";
		send(out, packet);
		if (Config.debug)
	...
	public static void GAME_SEND_ADD_ENEMY(Characters out, Characters pr)
	{
	...
	public static void GAME_SEND_iAEA_PACKET(Characters out)
	{
	...
	public static void GAME_SEND_ENEMY_LIST(Characters perso)
	{
	...
	public static void GAME_SEND_iD_COMMANDE(Characters perso, String str)
	{
	...
	public static void GAME_SEND_gT_PACKET(Characters perso, String str) 
	{ 
	...
	public static void GAME_SEND_EHP_PACKET(Characters out, int templateID)	//Packet d'envoie du prix moyen du template (En réponse a un packet EHP)
	{
	...
	public static void GAME_SEND_EHL_PACKET(Characters out, int categ, String templates)	//Packet de listage des templates dans une catégorie (En réponse au packet EHT)
	{
	...
	public static void GAME_SEND_EHL_PACKET(Characters out, String items)	//Packet de listage des objets en vente
	{
    ...
    public static void GAME_SEND_MERCHANT_LIST(Characters P, short mapID) 
    {
    	StringBuilder packet = new StringBuilder();
    	packet.append("GM|~");
    ...
    public static void GAME_SEND_cMK_PACKET_INCARNAM_CHAT(Characters perso, String suffix, int guid, String name, String msg) 
    { 
    	String packet = "cMK" + suffix + "|" + guid + "|" + name + "|" + msg; 
    	if (perso.get_lvl() > 15) 
    	{ 
	...
	public static void GAME_SEND_CIN_Packet(Characters perso, String num) { // Jouer une cinématique
		send(perso,"GA;2;" + perso.get_GUID() + ";" + num);
	}
	
	public static void GAME_SEND_TB_Packet(Characters perso) { // Jouer la cinématique de départ
		send(perso,"TB");
	}
	...
	public static void GAME_SEND_dCK_PACKET(Characters out, String id) //Ouvrir un livre
	{
		String packet = "dCK"+id;
		send(out,packet);
		if(Config.debug)
	...
	public static void GAME_SEND_OCO_PACKET(Characters out, Objects obj) {
